...
//首页广告01
function show_index(){
//document.writeln('<div style="border: 1px solid #E4E4E4;color:red;width:960px;line-height:25px;margin:5px auto;padding:0px;text-align:left;font-size: 18px;">&nbsp;&nbsp;&nbsp;&nbsp;请大家记住顶点小说域名www.x23us.com，谢谢各位书友的支持！</div>');
...
/*document.writeln("<li style=\"float:right;\"><form target=\"_blank\" action=\"https://zhannei.baidu.com/cse/search\" method=\"get\"><input type=\"hidden\" name=\"s\" value=\"5592277830829141693\"><input type=\"hidden\" name=\"entry\" value=\"1\"><input type=\"text\" name=\"q\" baidusug=\"2\" placeholder=\"提示:宁少字,别错字\" autocomplete=\"off\" style=\"width:200px\">  <input type=\"submit\" value=\"搜  索\"></form></li>");*/
document.writeln("<li style=\"float:right;\"><form target=\"_blank\" action=\"https://www.x23us.com/modules/article/search.php\" method=\"get\"><input name=\'searchtype\' type=\'hidden\' value=\'keywords\'/><input type=\"text\" name=\"searchkey\" placeholder=\"提示:宁少字,别错字\" autocomplete=\"off\" style=\"width:200px\">  <input type=\"submit\" value=\"搜  索\"></form></li>");
}

function bd_search(){
/*document.writeln("<form target=\"_blank\" action=\"https://zhannei.baidu.com/cse/search\" method=\"get\"><input type=\"hidden\" name=\"s\" value=\"5592277830829141693\"><input type=\"hidden\" name=\"entry\" value=\"1\"><dl class=\"fl searchbox\"><dt><i></i><input type=\"text\" name=\"q\" baidusug=\"2\" placeholder=\"提示:只能搜书名或作者,宁少字,别错字\" autocomplete=\"off\"> </dt><dd><button type=\"submit\" class=\"so_book\"></button></dd></dl></form>");*/
document.writeln("<form target=\"_blank\" action=\"https://www.x23us.com/modules/article/search.php\" method=\"get\"><input type=\"hidden\" name=\"searchtype\" value=\"keywords\"><dl class=\"fl searchbox\"><dt><i></i><input type=\"text\" name=\"searchkey\" placeholder=\"提示:只能搜书名或作者,宁少字,别错字\" autocomplete=\"off\"> </dt><dd><button type=\"submit\" class=\"so_book\"></button></dd></dl></form>");
}
...
function addFavorite2() {
  ...
  try{
   ...
   alert('您的浏览器不支持,请按 Ctrl+D 手动收藏!');
		...
		displayDialog('<!doctype html><html lang=\"en\"><head><meta charset=\"GBK\"><title>收藏</title></head><body><p style=\"color:red;width:360px;height:120px;line-height:30px;text-indent: 10px;font-size: 16px;padding-top: 30px;text-align:center;\">您的浏览器不支持,请按 Ctrl+D 手动收藏!<br><a href=\"https://www.x23us.com\">https://www.x23us.com&nbsp;&nbsp;&nbsp;顶点小说</a><br><input type="button" style=\"border: 2px solid #8bcee4;font-size: 20px;width:60px;height:30px;margin-top:15px\"onclick="closeDialog()" value="确&nbsp;定"></button></p></body></html>');
    }
}
